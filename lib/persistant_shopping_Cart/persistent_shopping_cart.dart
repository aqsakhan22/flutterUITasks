...
import 'package:flutteruitask/persistant_shopping_Cart/cart_view.dart';
import 'package:flutteruitask/persistant_shopping_Cart/components/network_image_widget.dart';
...
class ItemModel{
  String productId;
  String productName;
  String productDescription; String productThumbnail; int unitPrice;
  ItemModel({required this.productId, required this.productName,
  required this.productDescription,required this.productThumbnail,required this.unitPrice});
